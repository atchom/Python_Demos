...
Le camp de Méké, situé dans la région du Tigré, a connu en 2024 une année marquée par une forte instabilité des flux d’arrivées, des incidents logistiques majeurs et une pression croissante sur les ressources en eau.Le camp de Méké, situé dans la région du Tigré en Éthiopie, accueille des populations fuyant les conflits armés, l’insécurité alimentaire et les épisodes de sécheresse. L’année 2024 a été marquée par une forte variabilité des arrivées, des contraintes logistiques importantes et une pression croissante sur les ressources en eau.
...
## 📊 Synthèse visuelle du scénario 2024 (basée sur les arrivées mensuelles du graphe)
...
### Phase 1 — Janvier à mars : montée en charge rapide

- **Arrivées** : 2 836 personnes
- **Population** passant de ~8 200 à ~11 000 personnes.
- **Incident critique** : panne du camion → rationnement à 15 L/personne/jour.
- Le graphe montre une croissance continue malgré les contraintes logistiques.

### Phase 2 — Avril–mai : ralentissement temporaire

- **Avril** : 212 arrivées
- **Mai** : 326 arrivées
- **Population** quasi stable autour de 10 900 personnes.
- Le camp reste sous le seuil de saturation (13 300), mais la marge est faible.

### Phase 3 — Juin : afflux massif et rupture d’équilibre

- **Juin** : 2 328 arrivées
- **Population** bondit à 13 400 personnes, dépassant le seuil de saturation.
- **Activation du protocole d’urgence** (mentionné dans le graphe).
- Pression immédiate sur l’eau, les abris et les services de base.

### Phase 4 — Juillet–août : stabilisation relative mais au-dessus du seuil

- **Juillet** : 97 arrivées
- **Août** : 193 arrivées
- **Population** : 13 500 → 13 600 personnes.
- **Événement majeur** : forage d’un nouveau puits en août, visible sur le graphe.

### Phase 5 — Septembre à décembre : plateau élevé

- Le graphe indique une stabilisation.
